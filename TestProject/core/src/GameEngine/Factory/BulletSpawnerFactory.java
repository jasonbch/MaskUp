...
public class BulletSpawnerFactory {
    public BulletSpawner create(float xPos, float yPos, String movingPattern, float speed, String bullet, Texture texture, float timeBetweenShot, String bulletFormation, int maxTimeAlive, int maxHealth) {
